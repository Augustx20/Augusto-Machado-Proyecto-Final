...
const renderBotonCarrito = () => {
    let salida = `<button type="button" class="btn btn-info position-relative">
        <img src="images/basket.svg" alt="Compra" width="24">
        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success">${totalCarrito()}</span>
    </button>`;
